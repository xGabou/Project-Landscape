...
import com.gabou.atmospheregen.compat.projectatmosphere.PaRuntimeClimateProvider;
...
public final class RuntimeClimateLifecycle {
    ...
    public static BaselineContextStore baseline(ServerLevel level) {
        ...
        if(versions.baselineClimate()!=com.gabou.atmospheregen.generation.version.BaselineClimateAlgorithmVersion.PA_BASELINE_V1)return null;
