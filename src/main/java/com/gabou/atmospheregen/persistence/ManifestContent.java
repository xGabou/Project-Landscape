...
public record ManifestContent(GenerationVersions versions, long worldSeed, ResourceLocation dimension,
    ...
    public void validate() {
        ...
        if(versions.equals(GenerationVersions.geographyV1())||versions.equals(GenerationVersions.climateV1())) {
            ...
            if(climateV1!=baselineClimate.planned().isPresent()||biomeResolver.planned().isPresent()||biomeCatalog.isPresent())
