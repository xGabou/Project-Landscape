...
public final class PaBaselineClimateProvider implements BaselineClimateProvider {
    ...
    private final com.gabou.projectlandscape.runtime.BaselineContextStore runtimeContext = new com.gabou.projectlandscape.runtime.BaselineContextStore();
    private final com.gabou.projectlandscape.generation.cache.ExactCache<ClimateBaseline> cache=
            new com.gabou.projectlandscape.generation.cache.ExactCache<>(CAPACITY);
    ...
    @Override public ClimateBaseline sample(int x,int z) {
        ...
        return cache.get(key,ignored->{
            if (!com.gabou.projectlandscape.runtime.BaselineContextStore.isRepresentative(x,z)) return model.sample(geography,x,z);
            ...
            runtimeContext.record(new com.gabou.projectlandscape.runtime.BaselineContextStore.Context(x,z,latitude.degrees(z),result,local[0]));
            return result;
        });
    }
    public com.gabou.projectlandscape.runtime.BaselineContextStore runtimeContext(){return runtimeContext;}
