...
import com.gabou.projectlandscape.api.geography.MacroGeographyProvider.MacroSample;
import com.gabou.projectlandscape.config.MacroGeographySettings;
import com.gabou.projectlandscape.generation.seed.*;
import com.gabou.projectlandscape.geography.*;
import com.gabou.projectlandscape.geography.continent.PaMacroGeography;
import com.gabou.projectlandscape.geography.hydrology.PaRiverGenerator;
...
public final class PaTerrainBridge implements Continent {
    ...
    @Override public void apply(Cell cell,float x,float z) {
        ...
        cell.continentX=(int)site.x();cell.continentZ=(int)site.z();cell.continentId=(float)com.gabou.projectlandscape.geography.continent.MacroSiteField.unit(site.id());
    ...
    public Rivermap hydrology(Cell cell,float x,float z,Rivermap previous) {
        ...
        if(!sample.land()||sample.islandClass()!=com.gabou.projectlandscape.api.geography.MacroGeographyProvider.IslandClass.NONE)return previous;
