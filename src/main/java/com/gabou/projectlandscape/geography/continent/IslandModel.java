...
public final class IslandModel implements AutoCloseable {
    ...
    private void recordFrontHit(){if(com.gabou.projectlandscape.geography.terrain.TerrainMetrics.ENABLED)frontHits.increment();}
