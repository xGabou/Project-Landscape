...
final class SmoothingExperiment {
    static void run(GeneratorContext context,Path out)throws Exception {
        ...
        for(int[] point:new int[][]{{0,0},{47,48},{-224,-96},{-64,-1172},{64,468},{-64,-3907}}){
            ...
            var reference=Smoothing.make(context.preset.filters().smoothing,context.levels);var candidate=new com.gabou.projectlandscape.geography.terrain.ExactSmoothing(reference);
