...
$provenance=[ordered]@{schemaVersion=1;fixtureVersion=1;task='Task 2';run=$run;sourceHead=(git -C $root rev-parse HEAD);
    sourceDirty=@(git -C $root status --porcelain);comparator='cd1a0f8415030ba9f5e865d9abd4520e3c3a18ee';
